			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Zmyworklis-display": {
								"semanticObject": "Zmyworklis",
								"action": "display",
								"description": "Daily Activity Sheet application",
								"title": "Daily Activity Sheet",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Z.myworklis",
									"url": sap.ui.require.toUrl("Z/myworklis")
								}
							}
						}
					}
